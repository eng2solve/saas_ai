...
import { Eraser, FileText, Hash, Home, Image, LogOut, Pen, Scissors,Users } from "lucide-react";
...
const Sidebar = ({ sidebar, setSidebar }) => {
  ...
  return (
    <div
      className={`w-60 bg-white border-r border-gray-200 flex flex-col justify-between items-center max-sm:abosulte top-14 bottom-0 
        ${
