...
//  coming from the prbuiltui of tailwind css
    ...
    return (
        <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
                <div className="md:max-w-96">
                    ...
                    <p className="mt-4 text-sm">
                        ...
                        Transform your content creatin with our suite of premium AI tools. Write articles, generate image and enchance you workflow.
                    </p>
                </div>
            ...
            <p className="pt-4 text-center text-xs md:text-sm pb-5">
                Copyright 2025 ©Durgesh Private Limited All Right Reserved.
            </p>
        </footer>
    );
};
