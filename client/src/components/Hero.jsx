  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs">
        <button onClick={()=>navigate('/ai')} className="bg-primary text-white px-10 py-3 rounded-lg hover:scale-102 active:scale95 transition cursor-pointer">Start Creating now</button>
        <button className="bg-white px-10 py-3 rounded-lg hover:scale-102 active:scale95 transition cursor-pointer">Watch demo</button>      
      </div>
